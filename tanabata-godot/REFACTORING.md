...
**Где используется:**
- game_root._cycle_phase() — вызывается при необходимости (индикатор фазы в режиме I)
...
3. ✅ Переход BUILD → SELECTION (авто при 5 башнях или клик по индикатору в режиме I)
