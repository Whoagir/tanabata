...
- **scenes/game_root.gd**
  - Перехват ввода: `_unhandled_input` (клики мыши), `_input` (P, I, 1–3, 0).
  ...
  - Хоткей паузы (P) вызывает `GameManager.toggle_pause()`. Смена фазы — по клику по индикатору в режиме разработчика (I) или автоматически.
