...
- **AttackLinkRenderer** — линии между атакующими башнями (визуал связей).
- **CraftingVisualRenderer** — подсветка комбинаций крафта на карте.
- **OreRenderer** — руда (пульсирующая подсветка).
- **AuraRenderer** — круги аур активных башен.
- **PathOverlayLayer** — предпросмотр пути врагов и сброшенные чекпоинты.
