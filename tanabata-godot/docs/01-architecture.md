...
- Генерация карты
- Поиск пути
- Системы: ввод, волны, бой, снаряды, движение, энергосеть, батарея (BatterySystem), руда, статус-эффекты, крафт, вулкан, маяк, аурига (Auriga), редактор энерголиний (LineDragHandler)
