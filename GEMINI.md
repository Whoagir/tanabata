...
11. **НИКОГДА И НИ В КОЕМ СЛУЧАЕ НЕ ПОДТВЕРЖДАЙ СВОИ ЖЕ ПЛАНЫ И ДЕЙСТВИЯ**
12. При двух ошибка ОБЯЗАТЕЛЬНО используй вместо replace write_file для перезаписи файла целиком. Это более надежный метод для рефакторинга
13. **ПЕРЕД КАЖДЫМ ГЛОБАЛЬНЫМ ДЕЙСТВИЕМ СПРАШИВАЙ И ЖДИ МОЕГО РАЗРЕШЕНИЯ**
